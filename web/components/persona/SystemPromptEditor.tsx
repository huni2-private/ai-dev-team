    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
        ...
        <textarea
          ...
          rows={2}
          className="w-full bg-white border border-blue-200 rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-400 resize-y"
      ...
      <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
        ...
        <textarea
          ...
          rows={4}
          className="w-full bg-white border border-purple-200 rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-purple-400 resize-y"
      ...
      <div className="rounded-lg border border-red-200 bg-red-50 p-4">
        ...
        <textarea
          ...
          rows={4}
          className="w-full bg-white border border-red-200 rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-red-400 resize-y"
